  ...
  <div class="mt-8 bg-primary">
    <div class="relative bg-white py-32">
      ...
      >
        ...
        >
          <h2
            class="mb-6 font-sans text-3xl text-center font-bold tracking-tight sm:text-4xl sm:leading-none"
          >
          ...
          <form
            class="flex gap-3 items-center w-full mb-4 md:flex-row md:px-16"
          >
            <input
              placeholder="Email"
              required=""
    ...
    <!-- footer -->
    <div class="mx-auto w-full container pt-10 px-4 xl:px-0">
      <div class="flex flex-col justify-between md:flex-row">
        ...
        <div class="md:w-[316px]">
          <div class="mt-[23px] flex">
            <div
              class="flex h-[38px] w-[38px] items-center justify-center rounded-[75%]"
            >
              <svg
                width="24"
                height="24"
        ...
        >
          <div class="">
            <p
              class="text-deutziawhite font-inter text-[18px] font-medium leading-normal"
            >
              Pages
            </p>
            <ul>
